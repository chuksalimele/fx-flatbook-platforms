...
public class OrderDB {
    ...
    private static final String CREATE_TABLE_SQL_FOR_SELECTED_SYMBOLS
            ...
            + " swap REAL"
            + ");";
    private static final String ORDER_PARAM =  
    ...
    private static final String CREATE_TABLE_SQL_FOR_OPEN_ORDERS
     ...
     //sent orders does not neccessary mean the orders were successful.
    //It only means the trader at least initiated the order to be sent
    private static final String CREATE_TABLE_SQL_FOR_SENT_ORDERS
    ...
    public static void initializeDatabase() throws SQLException {
        try (Connection conn = dataSource.getConnection(); Statement stmt = conn.createStatement()) {
            ...
            stmt.execute(CREATE_TABLE_SQL_FOR_SENT_ORDERS);
    ...
    public static void insertSentOrder(ManagedOrder order) {
