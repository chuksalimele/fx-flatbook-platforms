...
abstract class AbstractOrder {
    ...
    public String stringify(String field_sep, String nested_field_sep) {
        ...
        strBuilder.append("orderID=").append(orderID)
                ...
                .append(field_sep).append("open_time=").append(open_time == null? 0:open_time.getTime())
                .append(field_sep).append("close_time=").append(close_time == null? 0:close_time.getTime())
