...
public class ManagedOrder extends AbstractOrder {
    ...
    private ManagedOrder(String req_identifier, int account_number, String str_order) throws OrderException, SQLException {
        this(req_identifier, account_number,str_order, FIELD_SEPARATOR, NESTED_FIELD_SEPARATOR);
    }

    private ManagedOrder(String req_identifier, int account_number, String str_order, String field_sep, String nested_field_sep) throws OrderException, SQLException {
